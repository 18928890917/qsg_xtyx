 ...
 * @description
 */
public class SK_IndexPraiseAdapter extends XCBaseAdapter<SK_IndexModel.DatasEntity.GoodsEntity.PraiseEntity>{
    ...
    public SK_IndexPraiseAdapter(Context context, List list) {
        super(context, list);
    }
