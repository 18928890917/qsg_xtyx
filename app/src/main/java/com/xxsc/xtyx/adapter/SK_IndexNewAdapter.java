 ...
 * @description
 */
public class SK_IndexNewAdapter extends XCBaseAdapter<SK_IndexModel.DatasEntity.GoodsEntity.NewEntity>{
    ...
    public SK_IndexNewAdapter(Context context, List list) {
        super(context, list);
    }
